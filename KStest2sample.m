...
function [fowb_sz_KS,D1000w_actsz_KS,D1000w_appsz_KS,MF_actsz_KS,fowb_actsz_KS,fowb_z_KS,...
...
set(gcf,'pos',[100,100,1200,800]);
    ...
    histogram(log10(size2(x1)),15,'binwidth',0.25,'Normalization','probability')
    hold on
    histogram(log10(size2(x2)),15,'binwidth',0.25,'Normalization','probability')
    plot([median(log10(size2(x1))),median(log10(size2(x1)))],[0,1],'b--','LineWidth',1.5)
    plot([median(log10(size2(x2))),median(log10(size2(x2)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    histogram(log10(size5(x3)),15,'binwidth',0.25,'Normalization','probability')
    hold on
    histogram(log10(size5(x4)),15,'binwidth',0.25,'Normalization','probability')
    plot([nanmedian(log10(size5(x3))),nanmedian(log10(size5(x3)))],[0,1],'b--','LineWidth',1.5)
    plot([median(log10(size5(x4))),median(log10(size5(x4)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    histogram(log10(size8(x5)),15,'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(size8(x6)),15,'binwidth',0.2,'Normalization','probability')
    plot([median(log10(size8(x5))),median(log10(size8(x5)))],[0,1],'b--','LineWidth',1.5)
    plot([median(log10(size8(x6))),median(log10(size8(x6)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    histogram(log10(size15(x7)),15,'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(size15(x8)),15,'binwidth',0.2,'Normalization','probability')
    plot([median(log10(size15(x7))),median(log10(size15(x7)))],[0,1],'b--','LineWidth',1.5)
    plot([median(log10(size15(x8))),median(log10(size15(x8)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    plot([nanmedian(log10(size24(x9))),nanmedian(log10(size24(x9)))],[0,1],'b--','LineWidth',1.5)
    plot([median(log10(size24(x10))),median(log10(size24(x10)))],[0,1],'--','color',[0.8500,0.3250,0.0980,0.5],'LineWidth',1.5)
    hold off
    ...
    plot([median(log10(size43(x11))),median(log10(size43(x11)))],[0,1],'b--','LineWidth',1.5)
    plot([median(log10(size43(x12))),median(log10(size43(x12)))],[0,1],'--','color',[0.8500,0.3250,0.0980,0.5],'LineWidth',1.5)
    hold off
...
fowb_sz_KS = [[szr2,szp2];[szr5,szp5];[szr8,szp8];[szr15,szp15];[szr24,szp24];[szr43,szp43]];
...
medx9 = nanmedian(log10(realsize24(x10)));
medx10 = nanmedian(log10(realsize24(x9)));
...
set(gcf,'pos',[100,100,1200,800]);
    ...
    subplot('position',[0.07,0.55,0.25,0.33])
    histogram(log10(realsize2(x1)),'binwidth',0.25,'Normalization','probability')
    hold on
    histogram(log10(realsize2(x2)),'binwidth',0.25,'Normalization','probability')  
    ...
    subplot('position',[0.39,0.55,0.25,0.33])
    histogram(log10(realsize5(x3)),'binwidth',0.25,'Normalization','probability')
    hold on
    histogram(log10(realsize5(x4)),'binwidth',0.25,'Normalization','probability')
    ...
    subplot('position',[0.71,0.55,0.25,0.33])
    histogram(log10(realsize8(x5)),'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(realsize8(x6)),'binwidth',0.2,'Normalization','probability')
    ...
    subplot('position',[0.07,0.1,0.25,0.33])
    histogram(log10(realsize15(x7)),'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(realsize15(x8)),'binwidth',0.2,'Normalization','probability')
    ...
    subplot('position',[0.39,0.1,0.25,0.33])
    histogram(log10(realsize24(x9)),'binwidth',0.25,'Normalization','probability')
    hold on
    histogram(log10(realsize24(x10)),'binwidth',0.25,'Normalization','probability')
    ...
    subplot('position',[0.71,0.1,0.25,0.33])
    histogram(log10(realsize43(x11)),'binwidth',0.25,'Normalization','probability')
    hold on
    histogram(log10(realsize43(x12)),'binwidth',0.25,'Normalization','probability')
...
medx9 = nanmedian(log10(size24(x10)));
medx10 = nanmedian(log10(size24(x9)));
...
set(gcf,'pos',[100,100,1200,800]);
    ...
    subplot('position',[0.07,0.55,0.25,0.33])
    histogram(log10(size2(x1)),'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(size2(x2)),'binwidth',0.2,'Normalization','probability')  
    plot([medx1,medx1],[0,1],'b--','LineWidth',1.5)
    plot([medx2,medx2],[0,1],'--','color',[0.8500,0.3250,0.0980],'LineWidth',1.5)
    hold off
    legend(sprintf('D(1000d) > %6.4f', median(D1000w2)),sprintf('D(1000d) < %6.4f', median(D1000w2)),'location','northeast')
    ...
    subplot('position',[0.39,0.55,0.25,0.33])
    histogram(log10(size5(x3)),'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(size5(x4)),'binwidth',0.2,'Normalization','probability')
    plot([medx3,medx3],[0,1],'b--','LineWidth',1.5)
    plot([medx4,medx4],[0,1],'--','color',[0.8500,0.3250,0.0980],'LineWidth',1.5)
    hold off
    legend(sprintf('D(1000d) > %6.4f', median(D1000w5)),sprintf('D(1000d) < %6.4f', median(D1000w5)),'location','northeast')
    ...
    subplot('position',[0.71,0.55,0.25,0.33])
    histogram(log10(size8(x5)),'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(size8(x6)),'binwidth',0.2,'Normalization','probability')
    plot([medx5,medx5],[0,1],'b--','LineWidth',1.5)
    plot([medx6,medx6],[0,1],'--','color',[0.8500,0.3250,0.0980],'LineWidth',1.5)
    hold off
    legend(sprintf('D(1000d) > %6.4f', median(D1000w8)),sprintf('D(1000d) < %6.4f', median(D1000w8)),'location','northeast')
    ...
    subplot('position',[0.07,0.1,0.25,0.33])
    histogram(log10(size15(x7)),'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(size15(x8)),'binwidth',0.2,'Normalization','probability')
    plot([medx7,medx7],[0,1],'b--','LineWidth',1.5)
    plot([medx8,medx8],[0,1],'--','color',[0.8500,0.3250,0.0980],'LineWidth',1.5)
    hold off
    legend(sprintf('D(1000d) > %6.4f', median(D1000w15)),sprintf('D(1000d) < %6.4f', median(D1000w15)),'location','northeast')
...
set(gcf,'pos',[100,100,1200,800]);
    ...
    subplot('position',[0.07,0.55,0.25,0.33])
    histogram(log10(realsize2(x1)),'binwidth',0.5,'Normalization','probability')
    hold on
    histogram(log10(realsize2(x2)),'binwidth',0.5,'Normalization','probability')
    hold off
    ...
    subplot('position',[0.39,0.55,0.25,0.33])
    histogram(log10(realsize5(x3)),'binwidth',0.5,'Normalization','probability')
    hold on
    histogram(log10(realsize5(x4)),'binwidth',0.5,'Normalization','probability')
    hold off
    legend('> median of mean flux','< median of mean flux','location','northeast')
    ...
    subplot('position',[0.71,0.55,0.25,0.33])
    histogram(log10(realsize8(x5)),'binwidth',0.5,'Normalization','probability')
    hold on
    histogram(log10(realsize8(x6)),'binwidth',0.5,'Normalization','probability')
    hold off
    legend('> median of mean flux','< median of mean flux','location','northeast')
    ...
    subplot('position',[0.07,0.1,0.25,0.33])
    histogram(log10(realsize15(x7)),'binwidth',0.5,'Normalization','probability')
    hold on
    histogram(log10(realsize15(x8)),'binwidth',0.5,'Normalization','probability')
    hold off
    legend('> median of mean flux','< median of mean flux','location','northeast')
    ...
    subplot('position',[0.39,0.1,0.25,0.33])
    histogram(log10(realsize24(x9)),'binwidth',0.5,'Normalization','probability')
    hold on
    histogram(log10(realsize24(x10)),'binwidth',0.5,'Normalization','probability')
    hold off
    legend('> median of mean flux','< median of mean flux','location','northeast')
    ...
    subplot('position',[0.71,0.1,0.25,0.33])
    histogram(log10(realsize43(x11)),'binwidth',0.5,'Normalization','probability')
    hold on
    histogram(log10(realsize43(x12)),'binwidth',0.5,'Normalization','probability')
    hold off
    legend('> median of mean flux','< median of mean flux','location','northeast')
...
MF_actsz_KS = [[realsizer2,realsizep2];[realsizer5,realsizep5];[realsizer8,realsizep8];[realsizer15,realsizep15];[realsizer24,realsizep24];[realsizer43,realsizep43]];
...
fowb_actsz_KS = [[r2,p2];[r5,p5];[r8,p8];[r15,p15];[r24,p24];[r43,p43]];
...
set(gcf,'pos',[100,100,1200,800]);
    ...
    histogram(log10(MFtotal(eqobslim)),'binwidth',0.5,'Normalization','probability') 
    hold on
    histogram(log10(MFtotal(noteqobslim)),'binwidth',0.5,'Normalization','probability') 
    hold off
...
set(gcf,'pos',[100,100,1200,800]);
    ...
    hold on
    histogram(log10(realsize2(x2)),'binwidth',0.25,'Normalization','probability')
    plot([nanmedian(log10(realsize2(x1))),median(log10(realsize2(x1)))],[0,1],'b--','LineWidth',1.5)
    plot([nanmedian(log10(realsize2(x2))),median(log10(realsize2(x2)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    hold on
    histogram(log10(realsize5(x4)),'binwidth',0.25,'Normalization','probability')
    plot([nanmedian(log10(realsize5(x3))),median(log10(realsize5(x3)))],[0,1],'b--','LineWidth',1.5)
    plot([nanmedian(log10(realsize5(x4))),median(log10(realsize5(x4)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    hold on
    histogram(log10(realsize8(x6)),'binwidth',0.2,'Normalization','probability')
    plot([nanmedian(log10(realsize8(x5))),median(log10(realsize8(x5)))],[0,1],'b--','LineWidth',1.5)
    plot([nanmedian(log10(realsize8(x6))),median(log10(realsize8(x6)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    hold on
    histogram(log10(realsize15(x8)),'binwidth',0.2,'Normalization','probability')
    plot([nanmedian(log10(realsize15(x7))),median(log10(realsize15(x7)))],[0,1],'b--','LineWidth',1.5)
    plot([nanmedian(log10(realsize15(x8))),median(log10(realsize15(x8)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    subplot('position',[0.39,0.1,0.25,0.33])
    histogram(log10(realsize24(x9)),'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(realsize24(x10)),'binwidth',0.2,'Normalization','probability')
    plot([nanmedian(log10(realsize24(x9))),median(log10(realsize24(x9)))],[0,1],'b--','LineWidth',1.5)
    plot([nanmedian(log10(realsize24(x10))),median(log10(realsize24(x10)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
    ...
    subplot('position',[0.71,0.1,0.25,0.33])
    histogram(log10(realsize43(x11)),'binwidth',0.2,'Normalization','probability')
    hold on
    histogram(log10(realsize43(x12)),'binwidth',0.2,'Normalization','probability')
    plot([nanmedian(log10(realsize43(x11))),median(log10(realsize43(x11)))],[0,1],'b--','LineWidth',1.5)
    plot([nanmedian(log10(realsize43(x12))),median(log10(realsize43(x12)))],[0,1],'--','color',[0.8500 0.3250 0.0980],'LineWidth',1.5)
    hold off
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%      
%%%% Redshift distribution seperated by upper limit of observation timespan
figure(60) 
set(gcf,'pos',[100,100,1200,800]);
    histogram(ztotal(eqobslim),'binwidth',0.5,'Normalization','probability')
    hold on
    ...
    sgt = sgtitle('Redshift Distribution Seperated by Upper limit of Observation Timespan');
    sgt.FontSize = 20;
    sgt.LineWidth = 2;  
    
[r,p] = kstest2(ztotal(noteqobslim),ztotal(eqobslim));
z_dis_by_obstimesapn_KS = [r,p];
...
D2000w_actsz_KS = [[realsizer2,realsizep2];[realsizer5,realsizep5];[realsizer8,realsizep8];[realsizer15,realsizep15];[realsizer24,realsizep24];[realsizer43,realsizep43]];
...
D1500w_actsz_KS = [[realsizer2,realsizep2];[realsizer5,realsizep5];[realsizer8,realsizep8];[realsizer15,realsizep15];[realsizer24,realsizep24];[realsizer43,realsizep43]];
end