...
function [sourcename,tau,ipl,Dnoise,foa,fob,fowa,fowb] = OVROgetlightcurve_1500(sourcename,dtlag,makeplots)
tic
%clc;clear;close all;
...
%for s = 1:1 % max(size(sourcename))
    ...
    g1500 = fittype('a*(1+b/1500)/(1+b/x) + Dnoise','coefficients',{'a','b'},'independent',{'x'},'problem',{'Dnoise'});  
    %a = D(1500d) b = tau_char x = tau
    ...
    % fitting
    fo1500 = fit(x',y',g1500,'problem',Dnoise); % fitting without weight
    foa = fo1500.a; fob = fo1500.b;
    fow1500 = fit(x',y',g1500,'weight',weight,'problem',Dnoise);% fitting with weight
    fowa = fow1500.a; fowb = fow1500.b;
    ...
    figure(2)
        ...
        txt1 = 'fitting with weight'; txt3 = ['D(\tau = 1500) = ',num2str(fowa)]; 
